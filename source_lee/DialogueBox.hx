	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		if (PlayState.SONG.song.toLowerCase()=='senpai' || PlayState.SONG.song.toLowerCase()=='roses' || PlayState.SONG.song.toLowerCase()=='thorns')
		...
		else if (PlayState.SONG.song.toLowerCase()=='adventure' || PlayState.SONG.song.toLowerCase()=='randomness' || PlayState.SONG.song.toLowerCase()=='nleeboy')
			{
				...
				portraitLeft.frames = Paths.getSparrowAtlas('leestory/Lee2Portrait', 'shared');
		...
		if (FlxG.keys.justPressed.ANY  && dialogueStarted == true)
		{
			...
			if (dialogueList[1] == null && dialogueList[0] != null)
			{
				if (!isEnding)
				{
					...
					if (PlayState.SONG.song.toLowerCase() == 'senpai' || PlayState.SONG.song.toLowerCase() == 'thorns' || PlayState.SONG.song.toLowerCase() == 'adventure' || PlayState.SONG.song.toLowerCase() == 'randomness')
