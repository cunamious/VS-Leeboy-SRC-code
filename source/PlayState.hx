...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'adventure':
				dialogue = CoolUtil.coolTextFile(Paths.txt('adventure/dialog'));
			case 'randomness':
			...
			case 'leebg':
				{
					defaultCamZoom = 1.0;
					curStage = 'leebg';
					var bg:FlxSprite = new FlxSprite(-200, -10).loadGraphic(Paths.image('nlee/bg2', 'shared'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
					...
					boppers.frames = Paths.getSparrowAtlas('nlee/bgBoppers','shared');
					boppers.animation.addByPrefix('bop', 'Bopping', 24, false);
